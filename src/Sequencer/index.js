...
class Sequencer extends Component {
  ...
  componentDidMount() {
    ...
    const myScore = new Score(200)
      .addNote('sixteenth', 'A-3')
      .addNote('sixteenth', 'C-4')
      .addNote('sixteenth', 'E-4')
      .addNote('sixteenth', 'G-4')
      .addNote('sixteenth', 'A-4')
      .addNote('sixteenth', 'C-5')
      .addNote('sixteenth', 'E-5')
      .addNote('sixteenth', 'G-5')
      .addNote('sixteenth', 'A-5')
      .addNote('sixteenth', 'C-6')
      .addNote('sixteenth', 'E-6')
      .addNote('sixteenth', 'G-6')
      .addNote('sixteenth', 'A-6')
      .addNote('sixteenth', 'G-6')
      .addNote('sixteenth', 'E-6')
      .addNote('sixteenth', 'C-6')
      .addNote('sixteenth', 'A-5')
